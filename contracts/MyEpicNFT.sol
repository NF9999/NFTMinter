...
contract MyEpicNFT is ERC721URIStorage {
  ...
  function makeAnEpicNFT() public {
    ...
    // Set the NFTs data.
    // json url includes the image metadata
    // the json is base64 encoded using https://www.utilities-online.info/base64
    // the image link in the json is also encoded using base64
